          ...
          {planDefs.map((plan, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`relative rounded-2xl border bg-card flex flex-col pt-2 ${
                  isFeatured
              ...
              >
                {plan.badge && (
                  <div
                    className={`absolute -top-2 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider whitespace-nowrap ${
                      isFeatured
