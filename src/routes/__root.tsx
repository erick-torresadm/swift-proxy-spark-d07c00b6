  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: META_PIXEL_BOOT }} />
        <noscript
          dangerouslySetInnerHTML={{
            __html:
              '<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1916111822410804&ev=PageView&noscript=1" alt="" />',
          }}
        />
        <HeadContent />
      </head>
