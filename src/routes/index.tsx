...
const FAQ_ITEMS = [
  { q: "O que é o plano ISP dedicado e para que serve?", a: "É um IP fixo hospedado num pool separado do datacenter genérico de automação, com reputação historicamente mais limpa. Serve pra rodar múltiplas contas em Instagram, WhatsApp, Facebook Ads e marketplaces com menos chance de bloqueio — mas não é um IP de operadora residencial (Vivo/Claro/Oi/TIM); nenhum proxy dedicado é." },
  { q: "Qual o valor mensal de um proxy dedicado no Brasil?", a: "Em média entre R$ 39 e R$ 90 por IP, dependendo da localização e do tipo. Na FastProxy o IPv6 dedicado começa em R$ 29,90/mês, o IPv4 em R$ 39,90 e o ISP dedicado em R$ 49,90." },
  ...
  { q: "Qual a diferença entre proxy IPv6, IPv4 e ISP?", a: "IPv6 é o mais barato e indicado para automação e scraping em larga escala. IPv4 tem compatibilidade máxima com qualquer plataforma. ISP é um pool dedicado separado do datacenter genérico, com reputação historicamente mais limpa — bom pra Instagram, WhatsApp e Facebook Ads, mas não é IP de operadora residencial." },
